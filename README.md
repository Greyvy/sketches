...
- [Bezier curves by Jamie Wong](http://jamie-wong.com/post/bezier-curves/)
- [Bezier curves by Freya Holmér](https://medium.com/@Acegikmo/the-ever-so-lovely-b%C3%A9zier-curve-eb27514da3bf)
- [Spurious splines by Anders Hoff](https://inconvergent.net/2016/spurious-splines/)
- [Shepherding random grids by Anders Hoff](https://inconvergent.net/2016/shepherding-random-grids/)
- [Shepherding random numbers by Anders Hoff](https://inconvergent.net/2016/shepherding-random-numbers/)
- [Some p5 experiments by Anders Hoff](https://inconvergent-sandbox.glitch.me/index.html)
- [Gray-Scott reaction diffusion in WebGL shaders](https://github.com/amandaghassaei/ReactionDiffusionShader)
- [Interactive guide to homogeneous coordinates by Words and Buttons](https://wordsandbuttons.online/interactive_guide_to_homogeneous_coordinates.html)
