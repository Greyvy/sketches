...
let sketch = ({ gl, width, height }) => {
    ...
    let draw_strip = regl({
        ...
        uniforms: {
            ...
            u_matrix: (_, props) => {
                let { u_t, u_random, u_time, u_phase } = props
                let tra = mat4.translate([], mat4.identity([]), [0, u_t, 0])
                let sca = mat4.scale([], tra, [1, 1, 1])
                let rot = mat4.rotate([], sca, PI*0.65, [1, 0, 0])
                let mat = mat4.rotate([], rot, u_time*TAU, [0, 0, 1])
