...
let sketch = async ({ gl, width, height }) => {
    ...
    let cube_draw = regl({
        ...
        uniforms: {
            ...
            u_matrix: (stats, props) => {
                ...
                let r0 = u_random.map(function(value) { return map(value, 0, 1, -1, 1) })
                // let r0 = u_random
    ...
    let cube_elements = new Array(512)
        .fill({})
    ...
    return ({ playhead }) => {
        ...
        cube_render(Object.assign(props ,{
            u_scale: [-1, 1, 1],
            u_translate: [-0.5, 0.5, 0],
        }))
        cube_render(Object.assign(props, {
            u_scale: [-1, -1, 1],
            u_translate: [-0.5, -0.5, 0],
