...
let sketch = ({ gl, width, height }) => {
    ...
    let icosphere_draw = regl({
        ...
        void main() {
            ...
            uv.x += sin(u_time*PI*2.0);
            uv.y += cos(u_time*PI*-2.0)*0.125;
            ...
            float noise = voronoi2d(vec2(sin(uv+u_random.rg*PI))*4.0);
        ...
        uniforms: {
            ...
            u_matrix: (stats, props) => {
                ...
                let rot = mat4.rotate([], tra, Math.sin(u_time*PI*2.0)*(PI/2), [-u_random[0], u_random[1], 0])
