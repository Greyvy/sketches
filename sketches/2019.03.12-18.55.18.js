    ...
    let cone_draw = regl({
        ...
        uniforms: {
            ...
            u_matrix: (_, props) => {
                ...
                let rot = mat4.rotate([], mat4.identity([]), u_t*(TAU-0.1),
                    [
                        Math.sin(u_time*TAU)+Math.cos(u_time*TAU*8),
                        Math.cos(Math.sin(u_time)*TAU)*0.5,
                        Math.sin(u_time*TAU)*0.5
                    ])
                ...
                //let mat = mat4.scale([], tra, [0.5, 0.5, 1])
